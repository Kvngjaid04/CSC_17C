...
{
    // Allocate new memory for the extended array
...
T SimpleVector<T>::popFrnt() {
    ...
    // Allocate new memory for the reduced array
    T *newAptr = new T[arraySize - 1];

    // Copy elements, shifting everything left
